...
public class MulticastService extends Service implements DriverInterface, Thread.UncaughtExceptionHandler {
    ...
    private MulticastService.MulticastReceiver multicastReceiver = null;
    ...
    public static void startDriver(Context context, String inputSource, Integer race_id, Bundle params) {
        if (inputSource.equals(context.getString(R.string.MULTICAST))) {
            ...
            Intent serviceIntent = new Intent(context, MulticastService.class);
    ...
    public static boolean stop(RaceActivity context) {
        if (context.isServiceRunning("com.marktreble.f3ftimer.driver.MulticastService")) {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        multicastReceiver = new MulticastService.MulticastReceiver();
